...
# Inherit non-empty twice and add slots at same time
{
  ...
  ok( $p3->f1, 'p2.f1' );
  ok( join('|', $p3->reflect->findImplementation('f1')), 'p3_parent*|self*' );
  ...
  ok( $p3->s1, 'p2.s1' );
  ok( join('|', $p3->reflect->findImplementation('s1')), 'p3_parent*|self*' );
  ...
  ok( join('|', $p3->reflect->findImplementation('f2')), 'p3_parent*|p2_parent*|self*' );
