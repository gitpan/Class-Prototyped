...
# Here we use parent** instead of parent* to move the parent slot up in
# precedence over class*.  In the previous tests, the destroy method wasn't
# inherited from $p1 because the destroy method in C::P by way of MyClass
# took precedence.
$record = '';
{
  my $p2 = MyClass->new(
